...
export async function template__init(){
    ...
    let _logo = `${FLAT_URL__THEME}project/${MAP__SLUG}/assets/images/logo-webapp-geodashboard-2024.png`;
    ...
    _container.innerHTML = `
      <div  style="width:100%;" 
        ...
        <button type="button" class="btn__main__toggle btn btn-outline-secondary"><i class="bi bi-chat-right"></i></button>
      </div>
    `;
