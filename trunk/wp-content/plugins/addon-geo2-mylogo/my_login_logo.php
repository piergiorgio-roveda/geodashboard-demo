...
function my_login_logo() {
	...
	$g_DFL_LABEL_MAIN_LOGO = get_stylesheet_directory_uri() ."/img/".$itemMap['g_attributes']->label_main_logo;
  ...
  wp_deregister_style('wp-admin');
	...
	$favicon = get_stylesheet_directory_uri() ."/img/".$itemMap['g_attributes']->favicon;
