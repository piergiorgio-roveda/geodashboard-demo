      ...
      <?php
        if(!empty($itemMap['g_attributes']->post_content)){
          ...
          <div class="card box-map-welcome" style="display:none;">
            <h5 class="card-header" style="color: black!important;">'.$g_map_title.'</h5>
            <div class="card-body">
...
<div class="footer-band">
  ...
  <div id="box-sidebar-avatar">
    <span style="color:#878787ff;font-size:15px;font-weight:750;">Via Massimiliano Magatti 1 · 6900 Lugano · Switzerland</span>
  </div>  
</div>
<!--HTML-END-->
