  <head>
    ...
    <meta name="author" content="<?php echo $gVariables['ERP_OWNER_GEOINFO_AZIENDA'];?>">
    ...
    <link rel="stylesheet" href="<?php echo $g_SOURCE_PATH;?>markers.css" />
    ...
    <link rel="stylesheet" href="<?php echo $g_SOURCE_PATH;?>js/json-viewer-js-master/src/style_custom.css" />
    <link rel="stylesheet" href="<?php echo $g_SOURCE_PATH;?>js/json-viewer-js-master/src/style_template_ecommerce.css" />
    <!-- ## -->

    <?php
    include(ABSPATH.THEME_PATH.'/template-part/template02-head-plus.php');
    ?>  
  </head>