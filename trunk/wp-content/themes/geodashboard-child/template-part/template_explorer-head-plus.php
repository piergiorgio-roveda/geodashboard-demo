<?php
$gVariables['map_title']='Explorer';
?>

<title><?php echo $gVariables['map_title'];?></title>
...
?>
  ...
  <meta property="article:publisher" 
    content="<?php echo $gVariables['PUBLISHER'];?>" />
  ...
  <meta property="og:title" 
    content="<?php echo $gVariables['map_title'];?>" />
  ...
  <meta property="og:image" 
    content="<?php echo $gVariables['DFL_IMAGE_MAIN'];?>" />
  ...
  <meta name="twitter:site" 
    content="<?php echo $gVariables['TWITTER_SITE'];?>" />
  <meta name="twitter:creator" 
    content="<?php echo $gVariables['TWITTER_CREATOR'];?>">
