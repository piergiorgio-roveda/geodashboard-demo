  <head>
    ...
    <meta name="generator" content="WatchDOG">

    <title><?php echo $g_map_title;?></title>
    <meta property="og:title" content="<?php echo $g_map_title;?>" />
    <meta name="twitter:title" content="<?php echo $g_map_title;?>" />
    ...
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri();?>/src/css/wiki_style_default.css?ver=<?php echo APP_VERSION;?>" />
