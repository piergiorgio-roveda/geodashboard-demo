...
* install Wordpress
* overwrite wp-content folder with this repository /trunk/wp-content
* rename original wp-config.php file in wp-config-original.php
* copy in root the files in /trunk/
  * env-h3.php
